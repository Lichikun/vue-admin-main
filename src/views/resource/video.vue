<template>
    <div class="app-container" v-if="loadComolete">
      ...
      >
        ...
        <el-table-column label="视频" align="center">
          ...
          /> -->
          <video :src="`${PIC.pictureurl}${scope.row.url}`" controls id="audio_demo" style="height: 300px;"></video>
          </template>
        </el-table-column>
  ...
  import {pictureurl,deletePicture,addPicture,uploadPet,uploadGoods, getPictureList, uploadVideo} from "@/api/apis/picUrl";
  import { addVideo,deleteVideo,getVideoList} from "@/api/apis/videofile";
  import {getVedioFile} from "@/api/apis/pets";  
  import {getGoodsVideoFile} from "@/api/apis/goods";
    ...
    methods: {
      ...
      submitUpload(){
        const self = this
          ...
          if(this.curOpt == "宠物"){
            uploadVideo(this.formData).then(response => {
